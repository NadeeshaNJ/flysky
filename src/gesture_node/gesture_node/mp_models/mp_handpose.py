...
class MPHandPose:
    ...
    def setBackendAndTarget(self, backendId, targetId):
        self.backend_id = backendId
        self.target_id = targetId
        # No-op: inference runs on onnxruntime (CPU).
    ...
    def infer(self, image, palm):
        ...
        # Forward (onnxruntime; outputs in graph order: landmarks, conf, handedness, world)
        output_blob = self.session.run(None, {self.input_name: input_blob})
