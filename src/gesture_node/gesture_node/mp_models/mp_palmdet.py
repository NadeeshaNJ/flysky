...
class MPPalmDet:
    def __init__(self, modelPath, nmsThreshold=0.3, scoreThreshold=0.5, topK=5000, backendId=0, targetId=0):
        ...
        # cv2.dnn can't run the handpose model on OpenCV 4.6, so we use
        # onnxruntime for both models for consistency.
    ...
    def setBackendAndTarget(self, backendId, targetId):
        # No-op: inference runs on onnxruntime (CPU) regardless of cv.dnn backend.
        self.backend_id = backendId
        self.target_id = targetId
    ...
    def infer(self, image):
        ...
        # Forward (onnxruntime; outputs in graph order: boxes, scores)
